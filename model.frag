...
main() {
    ...
    // == =====================================================
    // Our lighting is set up in 3 phases:
    // directional, point lights and an optional flashlight
    // For each phase, a calculate function is defined that
    // calculates the corresponding color per lamp.
    // In the main() function we take all the calculated colors
    // and sum them up for this fragment's final color.
    // == =====================================================
